...
export const PROBES = {
  ...
  workspaceDisplay: { selector: 'section.workspace', prop: 'display' },
  workspaceColumns: { selector: 'section.workspace', prop: 'gridTemplateColumns' },
  sidebarSize: { selector: '.sidebar', prop: 'fontSize' },
  sideFootDisplay: { selector: '.side-foot', prop: 'display' },
  treeDisplay: { selector: '.tree', prop: 'display' },
  outputColumns: { selector: '.output', prop: 'gridTemplateColumns' },
  outputPadding: { selector: '.output', prop: 'padding' },
  outputSideDisplay: { selector: '.output-side', prop: 'display' },
  codeTitleSize: { selector: '.code-title', prop: 'fontSize' },
