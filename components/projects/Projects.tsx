...
const PROJECTS_DATA: ProjectIn[] = [
  ...
  },
  {
    ...
    stack: [{ name: 'Node.js' }, { name: 'MongoDB' }, { name: 'Express.js' }, { name: 'Javascript' }],
...
const REST_DATA: RestIn[] = [
  ...
  },
  {
    ...
    wordsToHighlight: ['Grid component', 'column spans', 'smooth integration', 'Compound Component Pattern'],
  },
  {
    id: '03',
    ...
    wordsToHighlight: ['customizable options', 'icons', 'limitations', 'integration', 'flexible configuration'],
  },
];
...
const HighlightText: React.FC<HighlightProps> = ({ text, wordsToHighlight }) => {
            ...
            <div className="flex flex-col xl:flex-row xl:gap-[30px]">
              ...
              <div className="w-full xl:w-[50%]">
                <Swiper
                  ...
                  onSlideChange={(data: SwiperIn) => setProject(PROJECTS_DATA[data?.activeIndex])}
                >
                    ...
                    return (
                      <SwiperSlide key={index} className="rounded-xl">
                        <div className="flex justify-center items-center bg-pink-50/5 rounded-xl">
                          <img src={project?.image} className="object-cover" alt={project?.title} />
                        </div>
                      </SwiperSlide>
                    );
                  })}
                ...
                <div className="flex justify-end">
                  <p className="text-sm text-white/50">
                    Total Projects : {PROJECTS_DATA?.length?.toString()?.padStart(2, '0')}
                  </p>
                </div>
              </div>
            </div>
          ...
          <TabsContent value={'1'} className="mt-0 w-full h-full">
            <div className="flex flex-col gap-10">
              {REST_DATA?.map((item: RestIn) => {
                return (
                  <div key={item?.id} className="flex-1 flex flex-col justify-center gap-2 group cursor-pointer">
                    ...
                    <p className="text-white/60 text-sm">
                      <HighlightText text={item?.desc} wordsToHighlight={item?.wordsToHighlight || []} />
                    </p>
